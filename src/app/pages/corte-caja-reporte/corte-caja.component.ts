...
@Component({
  selector: 'app-corte-caja-reporte',
  templateUrl: './corte-caja.component.html',
  styleUrls: ['./corte-caja.component.css'],
})
export class CorteCajaReporteComponent implements OnInit {
  ...
  generarReporte(){
    ...
    window.open(`http://172.16.0.4:82/api/Reportes/${this.IDCorte}`, "_blank");

    // this.FacturasService.GenerarCorteReporteID(this.IDCorte)
    // .then((result: any) => {
    //   Swal.fire({
